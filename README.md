...
**Scope:** Tools where AI or LLMs play a meaningful role in extraction, navigation, or content understanding. General-purpose scrapers (Scrapy, BeautifulSoup) belong in [awesome-web-scraping](https://github.com/lorien/awesome-web-scraping) ⭐ 8,161 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-19. Autonomous browser agents belong in [awesome-web-agents](https://github.com/steel-dev/awesome-web-agents) ⭐ 1,572 | 🐛 25 | 🌐 Python | 📅 2026-08-25.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 116,339 | 🐛 512 | 🌐 Python | 📅 2026-09-26 - Agent framework commonly used for scraping complex, login-walled sites. ![GitHub Repo stars](https://img.shields.io/github/stars/browser-use/browser-use?style=social)
* [Crawl4AI](https://github.com/unclecode/crawl4ai) ⭐ 84,279 | 🐛 203 | 🌐 Python | 📅 2026-09-25 - LLM-friendly web crawler with Markdown output and JSON-schema or LLM-based extraction. Python. ![GitHub Repo stars](https://img.shields.io/github/stars/unclecode/crawl4ai?style=social)
* [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 83,786 | 🐛 1 | 🌐 Python | 📅 2026-09-25 - Adaptive Python framework with smart element tracking that relocates elements after site changes. Cloudflare Turnstile bypass, spider framework with pause/resume, and a built-in MCP server. ![GitHub Repo stars](https://img.shields.io/github/stars/D4Vinci/Scrapling?style=social)
* [ScrapeGraphAI](https://github.com/ScrapeGraphAI/Scrapegraph-ai) ⭐ 31,313 | 🐛 17 | 🌐 Python | 📅 2026-09-25 - Python scraper using LLM + graph pipelines. Describe data in natural language, get typed JSON. Works with OpenAI, Anthropic, Groq, Gemini, Ollama. ![GitHub Repo stars](https://img.shields.io/github/stars/ScrapeGraphAI/Scrapegraph-ai?style=social)
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 25,397 | 🐛 371 | 🌐 TypeScript | 📅 2026-09-25 - Browser automation framework with `act`, `extract`, and `observe` primitives over Playwright. ![GitHub Repo stars](https://img.shields.io/github/stars/browserbase/stagehand?style=social)
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 23,071 | 🐛 258 | 🌐 Python | 📅 2026-09-26 - Browser automation for forms, logins, and dynamic content. ![GitHub Repo stars](https://img.shields.io/github/stars/Skyvern-AI/skyvern?style=social)
* [Reader](https://github.com/jina-ai/reader) ⭐ 12,045 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-22 - Jina AI's URL-to-Markdown converter. Engine behind `r.jina.ai`. ![GitHub Repo stars](https://img.shields.io/github/stars/jina-ai/reader?style=social)
...
* [LaVague](https://github.com/lavague-ai/LaVague) ⭐ 6,388 | 🐛 106 | 🌐 Python | 📅 2025-01-21 - Natural language web automation framework. ![GitHub Repo stars](https://img.shields.io/github/stars/lavague-ai/LaVague?style=social)
* [CyberScraper 2077](https://github.com/itsOwen/CyberScraper-2077) ⭐ 3,265 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - LLM scraper with Streamlit UI. Supports OpenAI, Gemini, and Ollama. Tor support included. ![GitHub Repo stars](https://img.shields.io/github/stars/itsOwen/CyberScraper-2077?style=social)
* [ScraperAI](https://github.com/scraperai/scraperai) ⭐ 483 | 🐛 4 | 🌐 HTML | 📅 2025-09-18 - AI scraper with auto-detection of page types, pagination, and catalog cards. ![GitHub Repo stars](https://img.shields.io/github/stars/scraperai/scraperai?style=social)
...
* [Obscura](https://github.com/h4ckf0r0day/obscura) ⭐ 27,890 | 🐛 187 | 🌐 Rust | 📅 2026-09-25 - Rust-based headless browser. CDP-compatible with Puppeteer and Playwright. Built-in stealth and tracker blocking. ![GitHub Repo stars](https://img.shields.io/github/stars/h4ckf0r0day/obscura?style=social)
...
* [Fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) ⭐ 90,604 | 🐛 554 | 🌐 TypeScript | 📅 2026-09-22 - Anthropic's official fetch MCP server. URL-to-Markdown.
* [Scrapling MCP](https://scrapling.readthedocs.io/en/latest/ai/mcp-server/) - Built-in MCP server bundled with [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 83,786 | 🐛 1 | 🌐 Python | 📅 2026-09-25. Install with `pip install "scrapling[ai]"`.
* [Apify MCP](https://github.com/apify/actors-mcp-server) ⭐ 8,538 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-25 - Run any Apify Actor as an MCP tool. ![GitHub Repo stars](https://img.shields.io/github/stars/apify/actors-mcp-server?style=social)
* [Firecrawl MCP](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,514 | 🐛 152 | 🌐 JavaScript | 📅 2026-09-26 - Official MCP wrapper for Firecrawl's scrape, crawl, and extract endpoints. ![GitHub Repo stars](https://img.shields.io/github/stars/mendableai/firecrawl-mcp-server?style=social)
...
* [Bright Data MCP](https://github.com/brightdata/brightdata-mcp) ⭐ 2,657 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-17 - Search, scrape, and extract from 60+ sources with anti-bot bypass. 5,000 free requests/month. ![GitHub Repo stars](https://img.shields.io/github/stars/brightdata/brightdata-mcp?style=social)
...
* [RedPajama-Data-v2](https://github.com/togethercomputer/RedPajama-Data) ⭐ 4,990 | 🐛 43 | 🌐 Python | 📅 2026-06-03 - 30T-token open web dataset.
