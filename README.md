...
**Scope:** Tools where AI or LLMs play a meaningful role in extraction, navigation, or content understanding. General-purpose scrapers (Scrapy, BeautifulSoup) belong in [awesome-web-scraping](https://github.com/lorien/awesome-web-scraping) ⭐ 8,120 | 🐛 3 | 🌐 Makefile | 📅 2026-07-28. Autonomous browser agents belong in [awesome-web-agents](https://github.com/steel-dev/awesome-web-agents) ⭐ 1,539 | 🐛 10 | 🌐 Python | 📅 2026-07-10.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 109,548 | 🐛 363 | 🌐 Python | 📅 2026-08-18 - Agent framework commonly used for scraping complex, login-walled sites. ![GitHub Repo stars](https://img.shields.io/github/stars/browser-use/browser-use?style=social)
* [Crawl4AI](https://github.com/unclecode/crawl4ai) ⭐ 78,528 | 🐛 146 | 🌐 Python | 📅 2026-08-17 - LLM-friendly web crawler with Markdown output and JSON-schema or LLM-based extraction. Python. ![GitHub Repo stars](https://img.shields.io/github/stars/unclecode/crawl4ai?style=social)
* [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 74,832 | 🐛 5 | 🌐 Python | 📅 2026-08-11 - Adaptive Python framework with smart element tracking that relocates elements after site changes. Cloudflare Turnstile bypass, spider framework with pause/resume, and a built-in MCP server. ![GitHub Repo stars](https://img.shields.io/github/stars/D4Vinci/Scrapling?style=social)
* [ScrapeGraphAI](https://github.com/ScrapeGraphAI/Scrapegraph-ai) ⭐ 29,670 | 🐛 13 | 🌐 Python | 📅 2026-07-20 - Python scraper using LLM + graph pipelines. Describe data in natural language, get typed JSON. Works with OpenAI, Anthropic, Groq, Gemini, Ollama. ![GitHub Repo stars](https://img.shields.io/github/stars/ScrapeGraphAI/Scrapegraph-ai?style=social)
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 23,966 | 🐛 324 | 🌐 TypeScript | 📅 2026-08-18 - Browser automation framework with `act`, `extract`, and `observe` primitives over Playwright. ![GitHub Repo stars](https://img.shields.io/github/stars/browserbase/stagehand?style=social)
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,773 | 🐛 219 | 🌐 Python | 📅 2026-08-18 - Browser automation for forms, logins, and dynamic content. ![GitHub Repo stars](https://img.shields.io/github/stars/Skyvern-AI/skyvern?style=social)
* [Reader](https://github.com/jina-ai/reader) ⭐ 11,876 | 🐛 27 | 🌐 TypeScript | 📅 2026-05-22 - Jina AI's URL-to-Markdown converter. Engine behind `r.jina.ai`. ![GitHub Repo stars](https://img.shields.io/github/stars/jina-ai/reader?style=social)
...
* [CyberScraper 2077](https://github.com/itsOwen/CyberScraper-2077) ⭐ 3,217 | 🐛 3 | 🌐 Python | 📅 2026-08-02 - LLM scraper with Streamlit UI. Supports OpenAI, Gemini, and Ollama. Tor support included. ![GitHub Repo stars](https://img.shields.io/github/stars/itsOwen/CyberScraper-2077?style=social)
...
* [Obscura](https://github.com/h4ckf0r0day/obscura) ⭐ 21,553 | 🐛 80 | 🌐 Rust | 📅 2026-08-15 - Rust-based headless browser. CDP-compatible with Puppeteer and Playwright. Built-in stealth and tracker blocking. ![GitHub Repo stars](https://img.shields.io/github/stars/h4ckf0r0day/obscura?style=social)
...
* [Fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) ⭐ 89,644 | 🐛 527 | 🌐 TypeScript | 📅 2026-08-10 - Anthropic's official fetch MCP server. URL-to-Markdown.
* [Scrapling MCP](https://scrapling.readthedocs.io/en/latest/ai/mcp-server/) - Built-in MCP server bundled with [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 74,832 | 🐛 5 | 🌐 Python | 📅 2026-08-11. Install with `pip install "scrapling[ai]"`.
* [Firecrawl MCP](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,261 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-17 - Official MCP wrapper for Firecrawl's scrape, crawl, and extract endpoints. ![GitHub Repo stars](https://img.shields.io/github/stars/mendableai/firecrawl-mcp-server?style=social)
* [Apify MCP](https://github.com/apify/actors-mcp-server) ⭐ 4,018 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-17 - Run any Apify Actor as an MCP tool. ![GitHub Repo stars](https://img.shields.io/github/stars/apify/actors-mcp-server?style=social)
...
* [Bright Data MCP](https://github.com/brightdata/brightdata-mcp) ⭐ 2,596 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-12 - Search, scrape, and extract from 60+ sources with anti-bot bypass. 5,000 free requests/month. ![GitHub Repo stars](https://img.shields.io/github/stars/brightdata/brightdata-mcp?style=social)
