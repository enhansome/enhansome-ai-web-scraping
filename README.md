...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 111,700 | 🐛 390 | 🌐 Python | 📅 2026-08-30 - Agent framework commonly used for scraping complex, login-walled sites. ![GitHub Repo stars](https://img.shields.io/github/stars/browser-use/browser-use?style=social)
* [Crawl4AI](https://github.com/unclecode/crawl4ai) ⭐ 79,986 | 🐛 174 | 🌐 Python | 📅 2026-08-29 - LLM-friendly web crawler with Markdown output and JSON-schema or LLM-based extraction. Python. ![GitHub Repo stars](https://img.shields.io/github/stars/unclecode/crawl4ai?style=social)
* [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 77,265 | 🐛 5 | 🌐 Python | 📅 2026-08-25 - Adaptive Python framework with smart element tracking that relocates elements after site changes. Cloudflare Turnstile bypass, spider framework with pause/resume, and a built-in MCP server. ![GitHub Repo stars](https://img.shields.io/github/stars/D4Vinci/Scrapling?style=social)
* [ScrapeGraphAI](https://github.com/ScrapeGraphAI/Scrapegraph-ai) ⭐ 30,063 | 🐛 11 | 🌐 Python | 📅 2026-08-27 - Python scraper using LLM + graph pipelines. Describe data in natural language, get typed JSON. Works with OpenAI, Anthropic, Groq, Gemini, Ollama. ![GitHub Repo stars](https://img.shields.io/github/stars/ScrapeGraphAI/Scrapegraph-ai?style=social)
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,097 | 🐛 341 | 🌐 TypeScript | 📅 2026-08-30 - Browser automation framework with `act`, `extract`, and `observe` primitives over Playwright. ![GitHub Repo stars](https://img.shields.io/github/stars/browserbase/stagehand?style=social)
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,881 | 🐛 222 | 🌐 Python | 📅 2026-08-30 - Browser automation for forms, logins, and dynamic content. ![GitHub Repo stars](https://img.shields.io/github/stars/Skyvern-AI/skyvern?style=social)
* [Reader](https://github.com/jina-ai/reader) ⭐ 11,930 | 🐛 28 | 🌐 TypeScript | 📅 2026-05-22 - Jina AI's URL-to-Markdown converter. Engine behind `r.jina.ai`. ![GitHub Repo stars](https://img.shields.io/github/stars/jina-ai/reader?style=social)
...
* [ScraperAI](https://github.com/scraperai/scraperai) ⭐ 475 | 🐛 4 | 🌐 HTML | 📅 2025-09-18 - AI scraper with auto-detection of page types, pagination, and catalog cards. ![GitHub Repo stars](https://img.shields.io/github/stars/scraperai/scraperai?style=social)
...
* [Obscura](https://github.com/h4ckf0r0day/obscura) ⭐ 22,422 | 🐛 84 | 🌐 Rust | 📅 2026-08-29 - Rust-based headless browser. CDP-compatible with Puppeteer and Playwright. Built-in stealth and tracker blocking. ![GitHub Repo stars](https://img.shields.io/github/stars/h4ckf0r0day/obscura?style=social)
...
* [Fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) ⭐ 89,963 | 🐛 511 | 🌐 TypeScript | 📅 2026-08-28 - Anthropic's official fetch MCP server. URL-to-Markdown.
* [Scrapling MCP](https://scrapling.readthedocs.io/en/latest/ai/mcp-server/) - Built-in MCP server bundled with [Scrapling](https://github.com/D4Vinci/Scrapling) ⭐ 77,265 | 🐛 5 | 🌐 Python | 📅 2026-08-25. Install with `pip install "scrapling[ai]"`.
* [Firecrawl MCP](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,350 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-28 - Official MCP wrapper for Firecrawl's scrape, crawl, and extract endpoints. ![GitHub Repo stars](https://img.shields.io/github/stars/mendableai/firecrawl-mcp-server?style=social)
* [Apify MCP](https://github.com/apify/actors-mcp-server) ⭐ 5,384 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-27 - Run any Apify Actor as an MCP tool. ![GitHub Repo stars](https://img.shields.io/github/stars/apify/actors-mcp-server?style=social)
...
* [Bright Data MCP](https://github.com/brightdata/brightdata-mcp) ⭐ 2,616 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-12 - Search, scrape, and extract from 60+ sources with anti-bot bypass. 5,000 free requests/month. ![GitHub Repo stars](https://img.shields.io/github/stars/brightdata/brightdata-mcp?style=social)
